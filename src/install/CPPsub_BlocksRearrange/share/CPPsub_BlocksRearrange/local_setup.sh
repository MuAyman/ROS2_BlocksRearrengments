...
: ${AMENT_CURRENT_PREFIX:="/media/muayman17/New/Muhammad/BrightSkies Test/ROS2_BlocksRearrengments/src/install/CPPsub_BlocksRearrange"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/CPPsub_BlocksRearrange/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/CPPsub_BlocksRearrange/environment/path.sh"
